...
/// Extra features: `Visibility icon`, `Obscuring character`.
class BadPasswordInput extends BadInput {
  final int? maxLength;

  /// The character to display when the password is obscured.
  final String obscuringCharacter;

  /// The icon to display when the password is visible.
  final Widget visibleIcon;

  /// The icon to display when the password is invisible.
  ///
  /// Default to `'•'`
